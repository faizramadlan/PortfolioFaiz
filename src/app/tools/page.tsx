            ...
            <div className="brutal-border max-w-3xl w-full flex flex-col">
                ...
                <div className="p-8 flex flex-col gap-6">
                    ...
                    <div className="brutal-grid grid-cols-1 md:grid-cols-2 mt-4">
                        <a href="/tools/md-to-pdf" className="brutal-border p-6 hover:bg-[var(--foreground)] hover:text-[var(--background)] group transition-colors block">
                    ...
                    <a href="/" className="self-start mt-4 font-press-start text-[10px] hover:underline underline-offset-4 tracking-widest uppercase">
                        {'<'} RETURN HOME
                    </a>
                </div>
            </div>
